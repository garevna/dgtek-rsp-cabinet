...
const [route, action, serviceStatus] = ['customers', 'finish-cancel', 'Canceled']

export const finishServiceCancelation = async function (customerId, serviceId, date) {
